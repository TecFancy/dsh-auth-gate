...
import type { OriginCheckRequest, UserRecord, UsersSnapshot } from "../../shared/index.js";
import type { Session } from "../../session/index.js";
import { auditDenied, type AdminAuditContext } from "./audit.js";
...
export function originAccepted(deps: AdminDeps, req: IncomingMessage): boolean {
 ...
 */
function originRequest(req: IncomingMessage): OriginCheckRequest {
...
export function locateSession(deps: AdminDeps, req: IncomingMessage): Session | undefined {
...
export function lockoutSeconds(deps: AdminDeps, ctx: AdminAuditContext): number | undefined {
 ...
 */
function reauthAccepted(deps: AdminDeps, ctx: AdminAuditContext, input: ResetInput): boolean {
...
export async function hashOr503(
  deps: AdminDeps,
  res: ServerResponse,
  ctx: AdminAuditContext,
  input: ResetInput,
 ...
 */
export async function writeReset(
  deps: AdminDeps,
  res: ServerResponse,
  ctx: AdminAuditContext,
  hashed: string,
...
export async function revokeTarget(
  deps: AdminDeps,
  ctx: AdminAuditContext,
  secrets: readonly string[] = [],
): Promise<boolean> {
