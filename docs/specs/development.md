...
| Docs gate      | `npm run docs:check` (bilingual pairing + 50 KiB size red line + duplicate H2-H4 headings, root READMEs included; part of `verify` — see `docs/README.md` "文档规范") |
