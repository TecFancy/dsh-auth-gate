...
## Table 2 - the gate's own public endpoints (4 rows)
...
everyone out and a leaked one would matter: all four must answer, none may 401.
...
Five probes are not products of static discovery. Each is annotated with its source:
