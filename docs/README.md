...
| 目录                                                        | 内容                                                                                                                                                                                                          | 阅读时机                  |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| [`deployed/`](deployed/)                                    | 部署运维：deployment（验收清单 A–J、升级 5.1）、reverse-proxy（反代部署）、local-proxy（配置面本地代理）、entry-coverage-0.1.5-rc.2（0.1.5-rc.2 全部入口未认证覆盖证据，61/61 被拒）                          | 部署 / 排障 / 升级时      |
