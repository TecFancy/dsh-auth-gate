 ...
 */
function mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, replayGuard, log) {
...
export function apply(ctx, config) {
    ...
    ctx.effect(() => mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, replayGuard, log), "dsh-auth-gate: auth endpoints");
