...
import { DisabledSessionSweeper, PasswordGate, makePasswordChangeWiring, registerPasswordEndpoints, verifyPassword, } from "./features/password/index.js";
import { TotpReplayGuard, verifyTotpCode } from "./features/totp/index.js";
import { DEFAULT_TRUSTED_PROXIES, LoginRateLimiter, defaultUsersFilePath, loadUsersFile, makeClientIpResolver, parseClientIpPolicy, } from "./shared/index.js";
...
export const Config = z.object({
    ...
    clientIpHeader: z.string().default(""),
    trustedProxyCidrs: z.array(z.string()).default([...DEFAULT_TRUSTED_PROXIES]),
...
function mountAuthEndpoints(server, config, auth, resolveToken, launchTokenBridge, usersPath, limiter, replayGuard, challengeMacKey, log) {
    ...
    const replayCheck = (username, counter, code) => replayGuard.checkAndRecord(username, counter, code);
