...
import { PasswordGate, registerPasswordEndpoints, verifyPassword, } from "./features/password/index.js";
 ...
 */
function mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, replayGuard, challengeMacKey, log) {
...
export function apply(ctx, config) {
    ...
    ctx.effect(() => mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, replayGuard, challengeMacKey, log), "dsh-auth-gate: auth endpoints");
