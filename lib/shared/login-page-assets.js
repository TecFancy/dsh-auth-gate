...
.notice{margin:0 0 12px;padding:8px 12px;border-left:3px solid var(--focus);border-radius:0 8px 8px 0;background:var(--wash);color:var(--ink);font-size:13px;line-height:20px}
...
`;
export const EYE_OPEN_SVG = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>';
...
`;
//# sourceMappingURL=login-page-assets.js.map