window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function AccountPasswordForm({ t, close }) {
			...
			if (form.success !== null) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					typeof close === "function" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: close,
						style: BUTTON_STYLE,
						children: t(ACCOUNT_KEYS.close)
					}) : null
				]
			});
		...
		*/
		function SettingsAccountSection({ t, close }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountPasswordForm, {
				t: translate,
				close
			});
		}
