...
async function handleTotpSubmit(deps, res, username, code, next, ip, host) {
    ...
    await issueSession(deps, res, store, username, next, [buildSetCookie(CHALLENGE_COOKIE, "", 0, deps.cookieSecure)], host);
}
