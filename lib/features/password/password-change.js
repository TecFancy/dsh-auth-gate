import { checkPasswordPolicy, checkRequestOrigin, parseCookieHeader, parseFormBody, } from "../../shared/index.js";
import {} from "../../session/index.js";
import { methodNotAllowed } from "../../http/index.js";
import { DUMMY_HASH } from "./password.js";
import { handlePasswordChangePage, respondChanged, respondFormError, sendJson, sendUnavailable, } from "./password-change.ssr.js";
...
export async function handlePasswordChange(deps, req, res) {
    ...
    if (!originAccepted(deps, req, res))
        return;
 ...
 */
function originAccepted(deps, req, res) {
